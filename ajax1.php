...
if (isset($_POST['login'])) {
    ...
    if (!$email && !$password)
     {
        header('Location:customerlogin.php?empty');
     } 
    else 
    {
       // $password=md5($password);
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            header('Location:index1.php?dashboard');
        } else {
            header('Location:customerlogin.php?loginE');
        }
    }
...
if (isset($_GET['delete_room'])) {
    ...
    $result = mysqli_query($connection, $sql);
    if ($result) {
        header("Location:index1.php?room_mang&success");
    } else {
        header("Location:index1.php?room_mang&error");
    }
}
...
if (isset($_POST['createComplaint'])) {
    ...
    $result = mysqli_query($connection, $query);
    if ($result) {
        header("Location:index1.php?complain&success");
    } else {
        header("Location:index1.php?complain&error");
    }
...
if (isset($_POST['resolve_complaint'])) {
    ...
    $result = mysqli_query($connection, $query);
    if ($result) {
        header("Location:index1.php?complain&resolveSuccess");
    } else {
        header("Location:index1.php?complain&resolveError");
    }
}
...
if (isset($_POST['change_shift'])) {
    ...
    if ($result && $insert_result && $update_result) {
        header("Location:index1.php?staff_mang&success");
    } else {
        header("Location:index1.php?staff_mang&error");
    }
}