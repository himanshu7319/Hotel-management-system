...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">Developed By Balram kumar</p>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
               <!-- <a class="btn btn-primary" style="border-radius:60px;" href="index2.php?reservation"><i class="fa fa-check-circle"></i></a> -->
            </div>
        </div>
