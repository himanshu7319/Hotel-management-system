$('#addRoom1').submit(function () {
    var room_type_id = $('#room_type_id1').val();
    ...
    $.ajax2({
        ...
        success: function (response) {
            if (response.done == true) {
                $('#addRoom1').modal('hide');
                window.location.href = 'index2.php?room_mang1';
            } else {
...
$('#roomEditFrom1').submit(function () {
    var room_type_id = $('#edit_room_type1').val();
    var room_no = $('#edit_room_no1').val();
    var room_id = $('#edit_room_id1').val();
...
$(document).on('click', '#roomEdit1', function (e) {
    e.preventDefault();
    ...
    $.ajax2({
        ...
        success: function (response) {
            if (response.done == true) {
                $('#edit_room_type1').val(response.room_type_id);
                $('#edit_room_no1').val(response.room_no);
                $('#edit_room_id1').val(room_id);
            } else {
...
$('#booking').submit(function () {
    ...
    if(!room_no && !first_name && !contact_no && !id_card_no && !address){
        ...
        $.ajax2({
            ...
            success: function (response) {
                if (response.done == true) {
                    $('#getCustomerName1').html(first_name+' '+last_name);
                    $('#getRoomType1').html(room_type);
                    $('#getRoomNo1').html(room_no);
                    $('#getCheckIn1').html(check_in_date);
                    $('#getCheckOut1').html(check_out_date);
                    $('#getTotalPrice1').html(total_price);
                    $('#getPaymentStaus1').html("Unpaid");
                    $('#bookingConfirm1').modal('show');
...
$(document).on('click', '#checkInRoom1', function (e) {
    e.preventDefault();
    ...
    $.ajax2({
        ...
        success: function (response) {
            if (response.done == true) {
                $('#room_id').val(room_id);
                $('#getCustomerName1').html(response.name);
                $('#getRoomType1').html(response.room_type);
                $('#getRoomNo1').html(response.room_no);
                $('#getCheckIn1').html(response.check_in);
                $('#getCheckOut1').html(response.check_out);
                $('#getTotalPrice1').html(response.total_price + '/-');
                $('#getBookingID1').val(response.booking_id);
                $('#checkIn1').modal('show');
            } else {
                alert(response.data);
            }
...
$('#advancePayment1').submit(function () {

    var booking_id = $('#getBookingID1').val();
    var advance_payment1 = $('#advance_payment1').val();
...
$(document).on('click', '#checkOutRoom1', function (e) {
    e.preventDefault();
    ...
    $.ajax2({
        ...
        success: function (response) {
            if (response.done == true) {
                $('#getCustomerName_n1').html(response.name);
                $('#getRoomType_n1').html(response.room_type);
                $('#getRoomNo_n1').html(response.room_no);
                $('#getCheckIn_n1').html(response.check_in);
                $('#getCheckOut_n1').html(response.check_out);
                $('#getTotalPrice_n1').html(response.total_price + '/-');
                $('#getRemainingPrice_n1').html(response.remaining_price + '/-');
...
$('#checkOutRoom_n1').submit(function () {
    var booking_id = $('#getBookingId_n1').val();
